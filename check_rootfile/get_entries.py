...
def check_myhist(tag, sample, directory = "plots"):
    ...
    #print_yields("%s/myhist_%s_Era2016_v3p6.root" % (directory, tag), hist)
    #print_yields("%s/myhist_%s_Era2017_v3p6.root" % (directory, tag), hist)
    #print_yields("%s/myhist_%s_Era2018_v3p6.root" % (directory, tag), hist)

    #print_entries("%s/myhist_%s_Era2016_v3p6.root" % (directory, tag), hist)
    #print_entries("%s/myhist_%s_Era2017_v3p6.root" % (directory, tag), hist)
    #print_entries("%s/myhist_%s_Era2018_v3p6.root" % (directory, tag), hist)

    #print_entries("plots/myhist_%s_Era2016.root" % tag, hist)
    #print_entries("plots/myhist_%s_Era2017.root" % tag, hist)
    #print_entries("plots/myhist_%s_Era2018.root" % tag, hist)
...
#plots/myhist_TGJets_Era2017_v3p6.root
#plots/myhist_TGJets_Era2018_v3p6.root
#plots/myhist_TTGG_Era2016_v3p6.root
#plots/myhist_TTGG_Era2017_v3p6.root
#plots/myhist_TTGG_Era2018_v3p6.root
#plots/myhist_TTGJets_Era2016_v3p6.root
#plots/myhist_TTGJets_Era2017_v3p6.root
#plots/myhist_TTGJets_Era2018_v3p6.root
#plots/myhist_TTJets_Era2016_v3p6.root
#plots/myhist_TTJets_Era2017_v3p6.root
#plots/myhist_TTJets_Era2018_v3p6.root
